...
def main():
    ...
    out_dir = Path('cmpr_figs__lag_corrs')
    ...
    axes = plt.subplots(rows, cols, squeeze=False, figsize=fig_size, sharex=True, sharey=True)[1]
    ...
    out_fig_name = f'lag_corrs_{rank_lab}.png'
