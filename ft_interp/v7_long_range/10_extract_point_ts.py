...
def main():
    ...
    main_dir = Path(r'P:\Synchronize\IWS\Testings\fourtrans_practice\multisite_phs_spec_corr\5min\v7_long_range')
    os.chdir(main_dir)
    ...
    path_to_ras = Path(f'{var}/{var}{suff}.nc')
    ...
    for nc_variable_label in nc_variable_labels:
        ...
        out_df.to_csv(
            out_dir / f'ts_{nc_variable_label}{suff}.csv',
            sep=sep,
            float_format=float_fmt)
