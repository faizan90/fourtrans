...
def main():
    ...
    parts = ['orig', ]  # 'data', 'cos', 'sin', 'mag', 'phs',
    ...
    freq = '5min'  # None
    strt_date = '2009-01-01 00:00:00'  # '0' None
    end_date = '2009-03-31 23:59:00'  #  '182'None
    ...
    in_sep = ';'
    in_date_fmt = '%Y-%m-%d %H:%M:%S'  # '%Y-%m-%d' None
...
#         in_data_df = in_data_df.loc[strt_date:end_date]
