...
def main():
    ...
    main_dir = Path(
        r'P:\Synchronize\IWS\Testings\fourtrans_practice\multisite_phs_spec_corr\precipitation_kriging\ifted')
    ...
    test_files = [
        Path(r'neckar_6cats_ppt_1991_1991_obs.h5'),
    ...
    h5_vars = [
        ...
        'precipitation_kriging_0_to_182_1km/OK']
