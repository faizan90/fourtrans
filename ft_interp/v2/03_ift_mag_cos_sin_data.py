...
def main():
    ...
    parts = [
        'data/precipitation_kriging_0_to_182_1km_data.nc',
        'mag/precipitation_kriging_0_to_182_1km_mag.nc',
        'cos/precipitation_kriging_0_to_182_1km_cos.nc',
        'sin/precipitation_kriging_0_to_182_1km_sin.nc',
        ]
    ...
    out_nc = out_dir / r'precipitation_kriging_0_to_182_1km.nc'
