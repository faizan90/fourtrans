...
def main():
    ...
    main_dir = Path(r'P:\Synchronize\IWS\Testings\fourtrans_practice\multisite_phs_spec_corr\temperature_kriging\ifted')
    os.chdir(main_dir)
    ...
    path_to_ras = r'temperature_kriging_0_to_182_1km.nc'
    input_ras_type = 'nc'
