...
def main():
    ...
    in_mag_file = Path(r'neckar_6cats_temp_1991_1991_mag.h5')
    in_phs_file = Path(r'neckar_6cats_temp_1991_1991_phs.h5')

    beg_time = '1991-01-01'
    end_time = '1991-12-30'
    freq = 'D'

    out_file = Path(r'neckar_6cats_temp_1991_1991.h5')
