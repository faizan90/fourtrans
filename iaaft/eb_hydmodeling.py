...
def main():
    ...
    h5_dss = [f'cross_sims_S{i:02d}' for i in range(0, 32)]

    h5_dss += ['cross_sims_ref']
...
def hydmod_iaaft(args):
    ...
    in_ini_file = (
        Path(__file__).parents[0] / r'zaa_iaaft_hydmodeling_config.ini')
